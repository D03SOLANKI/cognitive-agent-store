...
const signUpSchema = z.object({
  ...
  userType: z.enum(['buyer', 'developer'], {
...
const SignUp = () => {
  ...
  const onSubmit = async (values: SignUpFormValues) => {
    try {
      setIsLoading(true);
      await signUp(values.email, values.password, values.fullName, values.userType);
