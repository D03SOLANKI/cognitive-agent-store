...
const HealthcarePage = () => {
  const agents = getAllAgents().filter(agent => agent.category === 'Healthcare');
      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="mb-10">
            ...
            <h1 className="text-3xl font-bold mb-3">Healthcare & Medical AI Agents</h1>
            <p className="text-slate-600">
              Discover AI agents for healthcare, medical diagnostics, and patient care
            </p>
          </div>
